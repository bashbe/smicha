...
SEIF_SUBJECTS = {
    ...
    5: "ביצה בתוך התרנגולת",
    # סעיפים ו-ח : מקרים הפטורים מהאיסור מהתורה — עישון, חמי טבריה, מי חלב,
    # חלב מתה/זכר, דם, ואיברים (עור/עצמות/שליא) — כולם מסתיימים ב"פטור" (סע' ו-ז
    # לפי הרמב"ם/טור/שו"ע כפי שמובא במקור, סע' ו קטע 123)
    6: "מקרים הפטורים מהאיסור",
    7: "מקרים הפטורים מהאיסור",
    8: "מקרים הפטורים מהאיסור",
    # סעיף ט : חלב הנמצא בקיבת הבהמה
    9: "חלב בתוך קיבת הבהמה",
    # סעיפים י-יא (מוזגים) : ייבוש עור קיבה/בשר + מעמיד (חלב קיבה, עור קיבה
    # כשרה/טמאה, זה וזה גורם) — שני הסעיפים עוסקים בעור הקיבה, מוזגו לנושא אחד
    10: "ייבוש והעמדה בעור קיבה",
    11: "ייבוש והעמדה בעור קיבה",
}
